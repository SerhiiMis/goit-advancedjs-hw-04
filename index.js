import{a as $,i as p,S as b}from"./assets/vendor-BGz2EIcA.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))t(e);new MutationObserver(e=>{for(const a of e)if(a.type==="childList")for(const u of a.addedNodes)u.tagName==="LINK"&&u.rel==="modulepreload"&&t(u)}).observe(document,{childList:!0,subtree:!0});function o(e){const a={};return e.integrity&&(a.integrity=e.integrity),e.referrerPolicy&&(a.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?a.credentials="include":e.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function t(e){if(e.ep)return;e.ep=!0;const a=o(e);fetch(e.href,a)}})();const S="46684790-07ddeec26d5334b4228888751",P="https://pixabay.com/api/",T={key:S,orientation:"horizontal",image_type:"photo",safesearch:!0,per_page:15};async function y(r,s=1){var o,t;try{const e=E(r),a=`${P}?q=${e}&page=${s}&${new URLSearchParams(T)}`;return(await $.get(a)).data}catch(e){throw console.error("Error fetching images:",e),new Error(`Error fetching images with status ${(o=e.response)==null?void 0:o.status} and response ${((t=e.response)==null?void 0:t.statusText)||""}`)}}function E(r){const s=r.split(/\s+/);let o="";for(const t of s){if((o+"+"+t).length>100)break;o+=(o?"+":"")+t}return o}const g=3e3,w="topRight";function l(r){p.warning({message:r,timeout:g,position:w,close:!1})}function O(r){p.error({message:r,timeout:g,position:w,close:!1})}function L(r,s=!1){if(r.length===0){O("Sorry, there are no images matching your search query. Please try again!");return}const o=r.map(t=>`<li class="gallery-item">
